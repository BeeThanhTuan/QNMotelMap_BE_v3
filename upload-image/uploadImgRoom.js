...
const IMAGE_DIR = `${dirname}/resources/img-rooms`;
...
// Function để xóa ảnh
function deleteImagesRoom(image) {
    if (image) {
...
module.exports = { uploadImagesRoom, deleteImagesRoom };